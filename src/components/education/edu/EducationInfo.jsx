    ...
    <div className={`flex flex-col justify-start`}>
      <div className="flex items-center mb-[20vw]">
        <InfoSection setSection={setSection} param="first" isMobile={isMobile}>
          ...
          <Info paragraph="Bachelor of Science in Software Engineering, ( 1st ). ">
            <SchoolIcon sx={{ fontSize: 22 }} />
          </Info>
          <Info paragraph="De Montfort University, Leicester, England.">
            <LocationOnIcon sx={{ fontSize: 22 }} />
          </Info>
          <Info paragraph="2020-2023">
      ...
      <div className="h-screen w-screen flex items-center mb-[20vw] ">
        <InfoSection setSection={setSection} param="second" isMobile={isMobile}>
          ...
          <Info paragraph="IT Technician with specialization in online applications.">
            <EngineeringIcon sx={{ fontSize: 30 }} />
          </Info>
          <Info paragraph="ZSTiO nr 1. Chorzów, Poland.">
            <LocationOnIcon sx={{ fontSize: 22 }} />
          </Info>
          <Info paragraph="2011-2015">
            <CalendarMonthRoundedIcon sx={{ fontSize: 22 }} />
          </Info>
      ...
      <div className="mb-[20vh] w-screen flex items-center">
        <InfoSection setSection={setSection} param="third" isMobile={isMobile}>
          ...
          <Button
            icon={<VisibilityIcon />}
            text="View online"
            link="https://coursera.org/share/23b81ece187b0654c98ada825c5a3ca2"
          />
          ...
          <Button
            icon={<VisibilityIcon />}
            text="View online"
            link="https://www.udemy.com/certificate/UC-79a9ec62-66fe-4a13-9890-f954ceadcfec/"
          />
          ...
          <Button
            icon={<VisibilityIcon />}
            text="View online"
            link="https://www.certiport.com/Portal/Pages/PrintTranscriptInfo.aspx?action=Cert&id=395&cvid=4yFp9n9HAW1ZqqgywoTHOg=="
          />

          <div className="h-[400px] mb-[40px]"></div>
        </InfoSection>
      </div>
    </div>
  );
